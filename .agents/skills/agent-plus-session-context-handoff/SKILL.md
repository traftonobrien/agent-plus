---
name: agent-plus-session-context-handoff
description: Save one Agent+ task restart state in the active project. Not cross-project sync or transcript export.
---
